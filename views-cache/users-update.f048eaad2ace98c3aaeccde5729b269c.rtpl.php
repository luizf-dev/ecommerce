  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <form role="form" action="/ecommerce/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/" method="post">
          <div class="box-body">
            <input type="hidden" class="form-control" id="iduser" name="iduser" value="<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
          ...
          <div class="box-footer">
            ...
            <a type="button" href="/ecommerce/admin/users/" class="btn btn-danger">Cancelar</a>
          </div>
        </form>
      </div>
  	</div>
