    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <h3 id="order_review_heading" style="margin-top: -25px; margin-left: 180px;">Detalhes do Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3><br>
