												...
												<tbody>
													...
													<tr class="cart_item">
														...
														<td class="product-name">															
															<a href="/ecommerce/product/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/"><img width="70" height="70" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>   															
