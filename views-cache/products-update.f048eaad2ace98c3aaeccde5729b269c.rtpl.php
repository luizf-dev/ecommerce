...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/ecommerce/admin/product/<?php echo htmlspecialchars( $products["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" id="file" name="file" value="<?php echo htmlspecialchars( $products["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
              <div class="box box-widget">
                <div class="box-body">
                  <img class="img-responsive" id="image-preview" width="100" src="<?php echo htmlspecialchars( $products["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="Photo">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-footer">
            ...
            <a href="/ecommerce/admin/product/" class="btn btn-danger">Cancelar</a>
          </div>
