...
<body>
  ...
  <div>
    <table class="head-wrap w320 full-width-gmail-android">
      <tr>
        <td background="https://www.filepicker.io/api/file/UOesoVZTFObSHCgUDygC"  width="100%" height="8" valign="top">
          <!--[if gte mso 9]>
    ...
    <table class="footer-wrap w320 full-width-gmail-android">
      <tr>
        <td></td>
        <td class="container">
