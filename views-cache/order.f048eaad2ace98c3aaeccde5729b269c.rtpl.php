    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/ecommerce/resources/site/img/logo.png" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            <address>
                ...
                <?php echo htmlspecialchars( $order["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>,<br> <?php echo htmlspecialchars( $order["descomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?><br>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
             <!--   <a href="/ecommerce/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status/" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Status</a> -->
